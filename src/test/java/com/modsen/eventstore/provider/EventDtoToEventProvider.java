...
public class EventDtoToEventProvider implements ArgumentsProvider {
    @Override
    public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) {
        return Stream.of(
                Arguments.of(null, null),
                Arguments.of(
                        new EventDto(null, null, null, null, null, null),
                        new Event(null, null, null, null, null, null, null)
                ),
                Arguments.of(
                        new EventDto("Subject", "Description", "Full Name", "01.01.2000", "00:00", "Venue"),
